...
create_store(StoreNum) :-
    ...
    forall((has_type(Frame, shop:'ShelfFrame'), triple(Frame, dul:hasLocation, Store)),
        ...
        get_valid_shelf(H2, W2, D2, W3, D3),
...
assert_path_for_all_layers(Frame, Depth, Width) :-
    ...
    forall(triple(Frame, soma:hasPhysicalComponent, Layer),
        (   
            ...
            (get_valid_layer(Depth, Width, D, W),
...
get_valid_shelf(180, 5, 6, 5, 6).
get_valid_shelf(180, 5, 10, 5, 10).
get_valid_shelf(180, _, _, W3, D3) :-
    W3 is 5, 
    D3 is 10.

get_valid_shelf(160, 4, 10, 4, 10).
get_valid_shelf(160, 5, 10, 5, 10).
get_valid_shelf(160, 6, 10, 6, 10).
get_valid_shelf(160, _, _, W3, D3) :-
    W3 is 6,
    D3 is 10.

get_valid_shelf(200, 5, 6, 5, 6).
get_valid_shelf(200, 5, 10, 5, 10).
get_valid_shelf(200, 5, 12, 5, 12).
get_valid_shelf(200, 6, 6, 6, 6).
get_valid_shelf(200, 6, 7, 6, 7).
get_valid_shelf(200, 6, 10, 6, 10).
get_valid_shelf(200, 6, 12, 6, 12).
get_valid_shelf(200, 7, 10, 7, 10).
get_valid_shelf(200, 7, 12, 7, 12).
get_valid_shelf(200, _, _, W3, D3) :-
    W3 is 7,
    D3 is 12.


get_valid_layer(4, 10, 4, 10).
get_valid_layer(4, _, 4, 10).
get_valid_layer(5, 6, 5, 6).
get_valid_layer(5, 7, 5, 7).
get_valid_layer(5, 10, 5, 10).
get_valid_layer(5, 12, 5, 12).
get_valid_layer(5, _, 5, 12).
get_valid_layer(6, 10, 6 ,10).
get_valid_layer(6, 12, 6 ,12).
get_valid_layer(6, _, 6 ,12).
get_valid_layer(7, _, 6, 12).
get_valid_layer(_, _, 6, 12).
