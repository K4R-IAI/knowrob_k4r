...
public:
  ...
  const bool post_material_group(const Json::Value &, Json::Value &);
  const bool post_material_group(const std::string &, const Json::Value &, Json::Value &);

  const bool put_material_group(const std::string &, const Json::Value &, Json::Value &);
...
const bool MaterialGroupController::post_material_group(const Json::Value &in_material_group, Json::Value &out_material_group)
{
  return this->post_data(in_material_group, out_material_group);
}
...
const bool MaterialGroupController::post_material_group(const std::string &in_parent_id, const Json::Value &in_material_group, Json::Value &out_material_group)
{
  ...
  return this->post_material_group(in_material_group_tmp, out_material_group);
}

const bool MaterialGroupController::put_material_group(const std::string &in_material_group_id, const Json::Value &in_material_group, Json::Value &out_material_group)
{
  return this->put_data(in_material_group, out_material_group, in_material_group_id);
}
...
const bool MaterialGroupController::put_material_group(const std::string &in_material_group_id, const std::string &in_parent_id, const Json::Value &in_material_group, Json::Value &out_material_group)
{
  Json::Value in_material_group_tmp = in_material_group;
  in_material_group_tmp["parentId"] = in_parent_id;
  return this->put_material_group(in_material_group_id, in_material_group_tmp, out_material_group);
}
