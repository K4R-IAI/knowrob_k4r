...
public:
  ...
  const bool post_shelf(const std::string &, const Json::Value &, Json::Value &);
  const bool post_shelf(const std::string &, const std::string &, const Json::Value &, Json::Value &);

  const bool put_shelf(const std::string &, const Json::Value &, Json::Value &);
...
const bool ShelfController::post_shelf(const std::string &in_store_id, const Json::Value &in_shelf, Json::Value &out_shelf)
{
  return this->post_data(in_shelf, out_shelf, "stores/" + in_store_id + "/shelves");
}
...
const bool ShelfController::post_shelf(const std::string &in_store_id, const std::string &in_product_group_id, const Json::Value &in_shelf, Json::Value &out_shelf)
{
  ...
  return this->post_shelf(in_store_id, in_shelf_tmp, out_shelf);
}

const bool ShelfController::put_shelf(const std::string &in_shelf_id, const Json::Value &in_shelf, Json::Value &out_shelf)
{
  return this->put_data(in_shelf, out_shelf, "shelves/" + in_shelf_id);
}
...
const bool ShelfController::put_shelf(const std::string &in_shelf_id, const std::string &in_store_id, const std::string &in_product_group_id, const Json::Value &in_shelf, Json::Value &out_shelf)
{
  ...
  in_shelf_tmp["productGroupId"] = in_product_group_id;
  return this->put_shelf(in_shelf_id, in_shelf_tmp, out_shelf);
}
