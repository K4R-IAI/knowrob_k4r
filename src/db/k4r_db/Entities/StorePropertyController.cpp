...
public:
  ...
  const bool post_store_property(const std::string &, const std::string &, const std::string &, Json::Value &);
...
const bool StorePropertyController::post_store_property(const std::string &in_store_id, const std::string &in_store_characteristic_id, const std::string &in_value, Json::Value &out_store_property)
{
  ...
  in_store_property["value"] = in_value;
